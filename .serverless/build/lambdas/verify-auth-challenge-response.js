...
// lambdas/verify-auth-challenge-response.ts
var verify_auth_challenge_response_exports = {};
__export(verify_auth_challenge_response_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(verify_auth_challenge_response_exports);
...
// node_modules/@authsignal/node/dist/index.mjs
var DEFAULT_API_BASE_URL = "https://api.authsignal.com/v1";
var Authsignal = class {
  constructor({ secret: secret2, apiBaseUrl: apiBaseUrl2, redirectUrl }) {
    this.secret = secret2;
    this.apiBaseUrl = apiBaseUrl2 !== null && apiBaseUrl2 !== void 0 ? apiBaseUrl2 : DEFAULT_API_BASE_URL;
    this.redirectUrl = redirectUrl;
  }
  async getUser(request) {
    const { userId } = request;
    const url2 = `${this.apiBaseUrl}/users/${userId}`;
  ...
  async track(request) {
    ...
    const url2 = `${this.apiBaseUrl}/users/${userId}/actions/${action}`;
  ...
  async getAction(request) {
    ...
    const url2 = `${this.apiBaseUrl}/users/${userId}/actions/${action}/${idempotencyKey}`;
    const config = this.getBasicAuthConfig();
    try {
      const response = await axios_default.get(url2, config);
      return response.data;
    } catch (err) {
      if (axios_default.isAxiosError(err) && ((_a = err.response) === null || _a === void 0 ? void 0 : _a.status) === 404) {
        return void 0;
      } else {
        throw err;
      }
  ...
  async enrollVerifiedAuthenticator(request) {
    ...
    const url2 = `${this.apiBaseUrl}/users/${userId}/authenticators`;
    const config = this.getBasicAuthConfig();
    const response = await axios_default.post(url2, data, config);
    return response.data;
  }
  async validateChallenge(request) {
    const url2 = `${this.apiBaseUrl}/validate`;
    const config = this.getBasicAuthConfig();
    const response = await axios_default.post(url2, request, config);
...
(function(UserActionState2) {
  UserActionState2["ALLOW"] = "ALLOW";
  UserActionState2["BLOCK"] = "BLOCK";
  UserActionState2["CHALLENGE_REQUIRED"] = "CHALLENGE_REQUIRED";
  UserActionState2["CHALLENGE_SUCCEEDED"] = "CHALLENGE_SUCCEEDED";
  UserActionState2["CHALLENGE_FAILED"] = "CHALLENGE_FAILED";
})(UserActionState || (UserActionState = {}));
var AuthenticatorType;
(function(AuthenticatorType2) {
  AuthenticatorType2["OOB"] = "OOB";
  AuthenticatorType2["OTP"] = "OTP";
})(AuthenticatorType || (AuthenticatorType = {}));
var OobChannel;
(function(OobChannel2) {
  OobChannel2["SMS"] = "SMS";
  OobChannel2["EMAIL_MAGIC_LINK"] = "EMAIL_MAGIC_LINK";
  OobChannel2["EMAIL_OTP"] = "EMAIL_OTP";
})(OobChannel || (OobChannel = {}));
var VerificationMethod;
(function(VerificationMethod2) {
  VerificationMethod2["SMS"] = "SMS";
  VerificationMethod2["AUTHENTICATOR_APP"] = "AUTHENTICATOR_APP";
  VerificationMethod2["RECOVERY_CODE"] = "RECOVERY_CODE";
  VerificationMethod2["EMAIL_MAGIC_LINK"] = "EMAIL_MAGIC_LINK";
  VerificationMethod2["PASSKEY"] = "PASSKEY";
  VerificationMethod2["PUSH"] = "PUSH";
  VerificationMethod2["SECURITY_KEY"] = "SECURITY_KEY";
  VerificationMethod2["VERIFF"] = "VERIFF";
  VerificationMethod2["IPROOV"] = "IPROOV";
  VerificationMethod2["EMAIL_OTP"] = "EMAIL_OTP";
})(VerificationMethod || (VerificationMethod = {}));

// lambdas/verify-auth-challenge-response.ts
var secret = process.env.AUTHSIGNAL_SECRET;
var apiBaseUrl = process.env.AUTHSIGNAL_URL;
var authsignal = new Authsignal({ secret, apiBaseUrl });
